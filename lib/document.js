...
Document.prototype.save = function(options, callback) {
  ...
  return this._save({}, false, {}, options, callback);
}
 ...
 * @return {Promise=}
 */
Document.prototype._save = function(docToSave, saveAll, savedModel, options, callback) {
  ...
  return util.hook({
    ...
    async: true,
    fn: self._saveHook,
    fnArgs: [docToSave, saveAll, savedModel, options, callback]
  });
}
 ...
 */
Document.prototype._saveHook = function(docToSave, saveAll, savedModel, options, callback) {
  var self = this;
  ...
  var p = new Promise(function(resolve, reject) {
    ...
    self.getModel().ready().then(function() {
      Promise.all(promises).then(function() {
        self._onSavedBelongsTo(copy, docToSave, belongsToKeysSaved, saveAll, savedModel, options, resolve, reject);
      }).error(reject);
    });
  });
...
Document.prototype._onSavedBelongsTo = function(
    copy, docToSave, belongsToKeysSaved, saveAll, savedModel, options, resolve, reject) {
  var self = this;
  ...
  self._saveSelf(copy, docToSave, belongsToKeysSaved, saveAll, savedModel, options, resolve, reject)
}
